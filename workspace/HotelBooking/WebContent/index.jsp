			...
			<div class="carousel slide" id="myCarousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="${pageContext.request.contextPath}/images/holl.jpg">
					...
					<div class="item">
						<img src="${pageContext.request.contextPath}/images/room3.jpg">
						<div class="carousel-caption">
							<h4>
					...
					<div class="item">
						<img src="${pageContext.request.contextPath}/images/room6.jpg">
						<div class="carousel-caption">
							<h4>
					...
					<div class="item">
						<img src="${pageContext.request.contextPath}/images/room7.jpg">
						<div class="carousel-caption">
							<h4>
					...
					<div class="item">
						<img src="${pageContext.request.contextPath}/images/room9.jpg">
						<div class="carousel-caption">
							<h4>
					...
					<div class="item">
						<img src="${pageContext.request.contextPath}/images/room10.jpg">
						<div class="carousel-caption">
							<h4>
